...
public class Biblioteca {
    ...
    public Biblioteca() {
        ...
        agregarUsuario("santiago","arenales",616111666,"santiago@gmail.com");
        //agregarUsuario(2);
        //agregarUsuario(3);
    }
    ...
    public void agregarUsuario(String nombre,String apellido,int telefono,String email) {
    ...
    public ArrayList<String> librosDelUsuario(int id){
        for(Usuario usuario:arrayUsuarios){
            if (usuario.getId_usuario()==id) {
